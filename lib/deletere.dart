...
class deleteReviews extends StatefulWidget {
  const deleteReviews({Key? key}) : super(key: key);
  @override
...
class _deleteReviewsState extends State<deleteReviews> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:AppBar(
        title:const Center(child: Text("Delete Reviews",style:TextStyle(
          ...
          child:Center(
            child:Column(
              children:  [
                ...
                const Text('Write the query to Delete contents the Reviews table',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 30,
