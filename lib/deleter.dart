...
class deleteRestaurant extends StatefulWidget {
  ...
  @override
  _deleteRestaurantState createState() => _deleteRestaurantState();
}
...
class _deleteRestaurantState extends State<deleteRestaurant> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:AppBar(
        title:const Center(child: Text("Delete Restaurant",style:TextStyle(
          ...
          child:Center(
            child:Column(
              children:  [
                ...
                const Text('Write the query to Delete contents the Restaurant table',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 30,
