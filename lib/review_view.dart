          ...
          child: Card(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    child: Text(posts[index].Rating,style: const TextStyle(fontWeight: FontWeight.bold,color:Colors.white,),
                    ),
                  ),
                ),
              ],
...
class HttpService {
  Future<List<Post>> getPosts() async {
    Response res = await get(
        Uri.parse('http://localhost/localconnect/review_change.php'));
    print(res.body);
